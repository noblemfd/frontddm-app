...
export class ExcelExportService {
  ...
  public exportAsExcelFile(
   ...
   // footerData: any,
    ...
    workbook.creator = 'Zenith DDMandate';
    workbook.lastModifiedBy = 'Zenith DDMandate';
