...
@Component({
  selector: 'app-create-dashboard-mandate',
  templateUrl: './create-dashboard-mandate.component.html',
  styleUrls: ['./create-dashboard-mandate.component.scss']
})
export class CreateDashboardMandateComponent implements OnInit {
